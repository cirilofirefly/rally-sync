        ...
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl">
          ...
          <div className="flex w-full flex-col gap-8 p-5 md:p-10">
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3 md:flex-row sm:items-center">
                <div className="flex gap-3 ">
                  <p className="p-bold-20 rounded-full bg-green-500/10 px-5 py-2 text-green-700">{ event.isFree ? 'FREE' : `${formatPrice(event.price as string)}` }</p>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="p-regular-20 flex items-center gap-3">
                <Image 
                  ...
                  height={32} 
                />
                <p className="p-mediumn-16 lg:p-regular-20">{event.loc}</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="p-medium-16 md:p-regular-18">
                {event.description}
              </p>
              <p className="p-medium-16 md:p-regular-18 truncate text-primary-500 underline">
                {event.url}
              </p>
            </div>
          </div>
